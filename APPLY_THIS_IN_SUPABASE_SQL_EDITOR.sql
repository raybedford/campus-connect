...
DO $$
BEGIN
  RAISE NOTICE '✅ conversation_keys table created successfully!';
  RAISE NOTICE 'E2EE with shared group keys is now enabled.';
  RAISE NOTICE 'New members will automatically get access to decrypt all messages!';
END $$;
